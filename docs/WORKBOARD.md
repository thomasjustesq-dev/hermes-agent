            ...
            Entry point for multi-agent coordination on **Hermes Agent**. Live claim state lives
            ...
            **Why:** a claim only on your topic branch is invisible to every other agent.
            ...
            | Surface | Why | Lease |
            | --- | --- | --- |
            | `src/` | Shared product surface | Prefer one live claim |
| `hermes/` | Shared product surface | Prefer one live claim |
